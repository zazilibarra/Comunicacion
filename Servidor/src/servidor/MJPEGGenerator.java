...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //MJPEGGenerator m = new MJPEGGenerator(new File("Ex02FF.avi"), 640, 480, framerate, numFrames);
        MJPEGGenerator m = new MJPEGGenerator(new File("Ex02FF.avi"), 640, 480, framerate, files.length);
        for (int i = 0; i < 50; i++) {
